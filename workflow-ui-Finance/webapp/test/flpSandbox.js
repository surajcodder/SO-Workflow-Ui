		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#FinanceWorkflowworkflowuiFinance-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"FinanceWorkflowworkflowuiFinance-display": {
								"semanticObject": "FinanceWorkflowworkflowuiFinance",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=FinanceWorkflow.workflowuiFinance",
									"url": sap.ui.require.toUrl("FinanceWorkflow/workflowuiFinance")
								}
							}
						}
					}
